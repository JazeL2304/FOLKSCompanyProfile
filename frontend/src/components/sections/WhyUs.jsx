      ...
      <section className="whyus" ref={sectionRef}>
        <div className="whyus__inner">
          <div className={`whyus__header ${triggered ? 'whyus__header--visible' : ''}`}>
            <h2 className="whyus__title">{t.whyus.title_1} <span>{t.whyus.title_2}</span> {t.whyus.title_3}</h2>
            <p className="whyus__subtitle">{t.whyus.subtitle}</p>
          </div>
            ...
            {featuresData.map((f, i) => (
              <div key={i} className={`whyus__card ${cardVisible[i] ? 'whyus__card--visible' : ''}`}>
                ...
                <div className="whyus__card-icon-wrap">
                  <img src={f.icon} alt={t.whyus.cards[i].title} className="whyus__card-icon" />
                </div>
                <h3 className="whyus__card-title">{t.whyus.cards[i].title}</h3>
                <p className="whyus__card-desc">{t.whyus.cards[i].desc}</p>
              </div>
            ))}
          </div>
        </div>
